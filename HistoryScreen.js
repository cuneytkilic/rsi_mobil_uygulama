...
const HistoryScreen = () => {
  ...
  // historyData'yı varsayılan olarak exit_date ve exit_time'a göre sıralı hale getiriyoruz
  const [sortedData, setSortedData] = useState(
    [...(historyData || [])].sort((a, b) => {
      const aDateTime = new Date(`${a.exit_date} ${a.exit_time}`);
      const bDateTime = new Date(`${b.exit_date} ${b.exit_time}`);
      return aDateTime - bDateTime; // En son gelen veri en üstte olacak şekilde sıralama
    })
  );
